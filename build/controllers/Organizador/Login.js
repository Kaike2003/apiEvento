...
exports.LoginOrganizador = exports.SECRET = void 0;
const prisma_1 = require("../../prisma");
const bcrypt_1 = __importDefault(require("bcrypt"));
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
exports.SECRET = "kaikebartolomeu";
const LoginOrganizador = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!senhaCorreta) {
            ...
            if (usuario.utilizador === "ORGANIZADOR"
                &&
...
exports.LoginOrganizador = LoginOrganizador;

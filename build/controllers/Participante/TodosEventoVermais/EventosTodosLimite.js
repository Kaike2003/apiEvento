...
exports.EventosTodosLimiteVermais = void 0;
const prisma_1 = require("../../../prisma");
const EventosTodosLimiteVermais = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(limite);
    const listarEventosTodosLimite = yield prisma_1.prisma.evento.findMany({
        where: {
            publicado: true,
            banido: false,
            aprovado: true,
...
exports.EventosTodosLimiteVermais = EventosTodosLimiteVermais;

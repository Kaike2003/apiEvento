...
exports.TeatroLimite = void 0;
const prisma_1 = require("../../../../prisma");
const TeatroLimite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { limite } = req.query;
    const limitar = Number(limite);
    console.log("Limitador", limitar);
    const categoriaNome = String("teatro");
...
exports.TeatroLimite = TeatroLimite;

...
exports.Concerto = void 0;
const prisma_1 = require("../../../../prisma");
const diaAtual = new Date().getDate();
const mesAtual = new Date().getMonth();
const anoAtual = new Date().getFullYear();
const Concerto = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const listBilhete = yield prisma_1.prisma.bilhete.findMany();
    const categoriaNome = String("concerto");

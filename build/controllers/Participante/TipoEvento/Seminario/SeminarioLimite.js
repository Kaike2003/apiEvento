...
exports.SeminarioLimite = void 0;
const prisma_1 = require("../../../../prisma");
const SeminarioLimite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { limite } = req.query;
    const limitar = Number(limite);
    console.log("Limitador", limitar);
    const categoriaNome = String("seminário");
...
exports.SeminarioLimite = SeminarioLimite;
